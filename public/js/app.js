...
var langPicker = document.getElementById('language-picker');
langPicker.addEventListener('click', function (e) {
  langPicker.classList.toggle('activated');

  var _iterator = _createForOfIteratorHelper(langPicker.children),
      _step;
...
langPicker.addEventListener('mouseover', function (e) {
  langPicker.classList.add('activated');

  var _iterator2 = _createForOfIteratorHelper(langPicker.children),
      _step2;
...
langPicker.addEventListener('mouseout', function (e) {
  langPicker.classList.remove('activated');

  var _iterator3 = _createForOfIteratorHelper(langPicker.children),
      _step3;
